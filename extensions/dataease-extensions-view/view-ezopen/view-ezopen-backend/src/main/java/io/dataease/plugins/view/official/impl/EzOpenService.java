...
import io.dataease.plugins.view.official.handler.EzOpenViewStatHandler;
...
@Service
public class EzOpenService extends ViewPluginService {

    private static final String VIEW_TYPE_VALUE = "ezopen";
    ...
    private StaticResource pluginSvg() {
        StaticResource staticResource = new StaticResource();
        staticResource.setName("view-ezopen-backend");
    ...
    public String generateSQL(PluginViewParam param) {
        ...
        String sql = new EzOpenViewStatHandler().build(param, this);
