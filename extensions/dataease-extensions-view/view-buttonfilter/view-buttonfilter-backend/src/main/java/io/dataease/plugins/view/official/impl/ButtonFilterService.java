...
import io.dataease.plugins.view.official.handler.ButtonFilterViewStatHandler;
...
@Service
public class ButtonFilterService extends ViewPluginService {

    private static final String VIEW_TYPE_VALUE = "buttonfilter";
    ...
    private StaticResource pluginSvg() {
        StaticResource staticResource = new StaticResource();
        staticResource.setName("view-buttonfilter-backend");
    ...
    public String generateSQL(PluginViewParam param) {
        ...
        String sql = new ButtonFilterViewStatHandler().build(param, this);
