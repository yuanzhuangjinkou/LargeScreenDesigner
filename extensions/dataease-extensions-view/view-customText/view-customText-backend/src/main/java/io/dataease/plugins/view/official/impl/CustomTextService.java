...
import io.dataease.plugins.view.official.handler.CustomTextViewStatHandler;
...
@Service
public class CustomTextService extends ViewPluginService {

    private static final String VIEW_TYPE_VALUE = "customText";
    ...
    private StaticResource pluginSvg() {
        StaticResource staticResource = new StaticResource();
        staticResource.setName("view-customText-backend");
    ...
    public String generateSQL(PluginViewParam param) {
        ...
        String sql = new CustomTextViewStatHandler().build(param, this);
