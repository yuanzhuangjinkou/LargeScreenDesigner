...
import io.dataease.plugins.view.official.handler.AlarmListViewStatHandler;
...
@Service
public class AlarmListService extends ViewPluginService {

    private static final String VIEW_TYPE_VALUE = "alarmList";
    ...
    private StaticResource pluginSvg() {
        StaticResource staticResource = new StaticResource();
        staticResource.setName("view-alarmList-backend");
    ...
    public String generateSQL(PluginViewParam param) {
        ...
        String sql = new AlarmListViewStatHandler().build(param, this);
