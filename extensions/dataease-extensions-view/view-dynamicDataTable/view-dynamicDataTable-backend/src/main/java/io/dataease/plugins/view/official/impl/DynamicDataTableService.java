...
@Service
public class DynamicDataTableService extends ViewPluginService {

    private static final String VIEW_TYPE_VALUE = "dynamicDataTable";
    ...
    private StaticResource pluginSvg() {
        StaticResource staticResource = new StaticResource();
        staticResource.setName("view-dynamicDataTable-backend");
